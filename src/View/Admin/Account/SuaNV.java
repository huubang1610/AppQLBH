...
public class SuaNV extends javax.swing.JFrame {
    ...
    public SuaNV(Account account) {
        ...
        position.setSelectedItem(account.getPosition());
    ...
    public boolean ExamInput(){
        boolean kt = true;
        if (txtIdUser.getText().equals("") || txtUserName.getText().equals("") || txtPassWord.getText().equals("") || txtFullName.getText().equals("") || txtEmail.getText().equals("") ||
                txtDiaChi.getText().equals("") || txtCCCD.getText().equals("")){
            kt = false;
        }
        if (Male.isSelected()== false && Female.isSelected() == false) {
            kt = false;
        }
        int t = (int) age.getValue();
        if (t == 0) {
            kt = false;
        }
        return kt;
    ...
    private void initComponents() {
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(rSButtonMetro2, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        position.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Manager", "Satff" }));
        ...
        txtCCCD.setMinimumSize(new java.awt.Dimension(6, 25));
    ...
    private void EditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditActionPerformed
        ...
        if (test == false) {
            ...
            String idUserAfter = txtIdUser.getText();
            ...
            String position = (String) this.position.getSelectedItem();
            byte[] avatar = person_image;
            Account account = new Account(idUserAfter, UserName, PassWord, FullName,position, Age, Email, avatar, cccd, address, sex);
            if (AccountController.update(idUserAfter, account) > 0) {
